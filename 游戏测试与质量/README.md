...
5. 阅读 [04-性能兼容与网络异常测试](04-性能兼容与网络异常测试.md)。前置知识：[游戏知识](../游戏知识/README.md) 的 `07-UI与性能优化`、`06-网络同步`。建议配合一台真机与一台低端机实操。

**阶段五：工程化收口**

6. 阅读 [05-CI质量门禁与缺陷管理](05-CI质量门禁与缺陷管理.md)。前置知识：`02`、`03`、`04` 的可执行产物（测试命令、报告格式）。目标是能把"质量红线"写进流水线，把"缺陷"管成闭环。
...
- 新增知识点：按"策略 / 客户端自动化 / 服务端压测 / 非功能验证 / 工程化"五个主题归入对应篇目；
