...
> 源码依据：`C:\Program Files\Epic Games\UE_5.8\Engine\Source\Runtime\Engine\Classes\Animation`、`Engine\Source\Runtime\Engine\Private\Animation`。
> 适用范围：Animation Montage、Blend Space、动画播放与运行时事件；本文是概念/使用层说明。
