...
| Nanite 渲染 | 已有（渲染概念 02-04） | 源码深度已完成：[35-Nanite源码.md](35-Nanite源码.md) |
| AnimNext/UAF 动画框架 | 已有（动画概念 04-05） | 源码深度已完成：[36-AnimNext与UAF源码.md](36-AnimNext与UAF源码.md) |
| Chaos 破坏与 Field | 已有（物理概念 09-05） | 源码深度已完成：[37-Chaos破坏与Field源码.md](37-Chaos破坏与Field源码.md) |
| PCG 程序化内容生成 | 已有（世界构建概念 13-04） | 源码深度已完成：[38-PCG源码.md](38-PCG源码.md) |
...
| [35-Nanite源码.md](./35-Nanite源码.md) | Nanite 集群层次、HW/SW 光栅化、Visibility Buffer、ShadingBin 着色与渲染 Pass 调度源码链路 | 源码深度已完成 |
